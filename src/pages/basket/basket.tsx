            ...
            <ul className="basket__list">
                ...
                <div className="basket-item__img">
                  <picture>
                    <source type="image/webp"
                      srcSet="../project/public/img/c../project/public/imgent/img9.webp, img/content/img9@2x.webp 2x"
                    />
                    <img src="../project/public/img/content/img9.jpg"
                      srcSet="../project/public/img/content/img9@2x.jpg 2x" width="140" height="120"
              ...
              <li className="basket-item">
                <div className="basket-item__img">
                  <picture>
                    <source type="image/webp"
                      srcSet="../project/public/img/c../project/public/imgent/img1.webp, img/content/img1@2x.webp 2x"
                    />
                    <img src="../project/public/img/content/img1.jpg"
                      srcSet="../project/public/img/content/img1@2x.jpg 2x" width="140" height="120"
